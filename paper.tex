...
\affiliate{CS}{University of Tokyo, Graduate School of Information Science and Technology, Department of Information Science}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth,natwidth=1024,natheight=295]{total_hist.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth,natwidth=2060,natheight=1398]{gap_stat.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth/3,natwidth=1024,natheight=805]{knn.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth/3,natwidth=411,natheight=362]{wrapping.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth/3,natwidth=451,natheight=548]{qr_flow.png}
